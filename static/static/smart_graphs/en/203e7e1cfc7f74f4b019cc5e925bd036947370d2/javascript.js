...
a.addObserver("y",this,this._valuesDidChange)},this)}.observes(".[]")});SmartGraphs.Axes=SC.Record.extend({xMax:SC.Record.attr(Number),xMin:SC.Record.attr(Number),yMax:SC.Record.attr(Number),yMin:SC.Record.attr(Number),yScale:SC.Record.attr(Number),xScale:SC.Record.attr(Number)});
...
b.push(c)}return b}());SmartGraphs.DataSeries=SC.Record.extend({points:SC.Record.toMany("SmartGraphs.DataPoint",{inverse:"series"})});
