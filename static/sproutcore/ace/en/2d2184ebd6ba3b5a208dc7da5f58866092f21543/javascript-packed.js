...
SC.Pane.prototype.baseTheme="sc-ace";sc_require("src/theme");SC.AceTheme.renderers.Well=SC.BaseTheme.renderers.Well.extend({render:function(a){if(this.contentProvider){this.contentProvider.renderContent(a)
