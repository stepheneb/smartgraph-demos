...
return V};SmartGraphs.GraphView=SC.View.extend({seriesBinding:"SmartGraphs.mainPage.mainPane.tableView.content",selectionBinding:"SmartGraphs.mainPage.mainPane.tableView.selection",highlighted:null,classNames:["graph-view"],displayProperties:["selection","series"],_isGraphed:false,_raphaelObjForId:{},_highlightedNodeId:undefined,NO_HIGHLIGHT_ATTR:{opacity:0.5,r:4},HIGHLIGHT_ATTR:{opacity:1,r:5},DATA_POINT_ID_MATCHER:/data-point-(\d+)/,render:function(b,f){var a=this.get("series");
...
t<k;t++){var o=g.objectAt(t);var f=m.left+(o[0]*z);var e=m.top+s-(o[1]*b);var q=n.circle(f,e).attr({stroke:"#aa0000",fill:"#aa0000"}).attr(this.NO_HIGHLIGHT_ATTR);
