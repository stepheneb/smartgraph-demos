...
},didCreateLayer:function(){console.log("HTMLView didCreateLayer()")}});SmartGraphs.RaphaelView=SC.View.extend({raphaelObject:null,_childViewForId:{},_lastViewForMouseMove:null,didCreateLayer:function(){var c=Raphael;
...
return this.get("calculatedHeight")+(a.top||0)+(a.bottom||0)}.property("calculatedHeight","layout").cacheable(),layout:{left:70,top:0,bottom:15,width:50},isEditable:YES,canEditContent:YES,contentValueKey:"y",contentBinding:"SmartGraphs.dataSeriesController.arrangedObjects",selectionBinding:"SmartGraphs.dataSeriesController.selection",rowHeight:18})})})})})});
