...
}}});SmartGraphs.mainPage=SC.Page.design({mainPane:SC.MainPane.design({layout:{width:960,height:720},childViews:"topLeftView bottomLeftView graphView tableView".w(),topLeftView:SC.LabelView.design({layout:{left:20,top:20,width:455,height:335},classNames:["blank-frame"]}),bottomLeftView:SC.LabelView.design({layout:{left:20,top:365,width:455,height:335},classNames:["blank-frame"]}),graphView:SmartGraphs.GraphView.design({layout:{left:485,top:20,width:455,height:335}}),tableView:SC.ListView.design({layout:{left:485,top:365,width:455,height:335},rowHeight:18})})});
